...
class penalized_ls_objective_vectorvaluedfunc_unbalanced(torch.nn.Module):
    def __init__(self, optim_base_kernel_parms, prior_kernel, base_kernel, batch_size, Xs_tuple, Ys_tuple, scores_tuple):
        ...
        """
        super(penalized_ls_objective_vectorvaluedfunc_unbalanced, self).__init__()
    ...
    def forward(self, batch_sample_indices_dict, regularizer_const, regularizer_const_FB, ifopt_hyper_parms, ifopt_model_parms):
        ...
        :param ifopt_hyper_parms:
        :param ifopt_model_parms:
        :return:
        """
...
class VV_CV_vectorvaluedfuncs_model_unbalanced(object):
