...
class penalized_ls_objective_vectorvaluedfunc_unbalanced_fixB_borehole(torch.nn.Module):
    def __init__(self, B, optim_base_kernel_parms, prior_kernel, base_kernel, batch_size, Xs_tuple, Ys_tuple, scores_tuple):
        ...
        """
        super(penalized_ls_objective_vectorvaluedfunc_unbalanced_fixB_borehole, self).__init__()
...
class VV_CV_vectorvaluedfuncs_model_unbalanced_fixB_borehole(object):
