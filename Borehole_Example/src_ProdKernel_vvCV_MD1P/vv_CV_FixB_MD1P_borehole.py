...
##=======================================================================================================================================
## 2. vvCVs for Borehole example and assume B can be pre-fixed
##=======================================================================================================================================

class penalized_ls_objective_vectorvaluedfunc_fixB_borehole(torch.nn.Module):
    def __init__(self, B, optim_base_kernel_parms, prior_kernel, base_kernel, batch_size, Xs_tensor, Ys_tensor, scores_Tensor):
        ...
        """
        super(penalized_ls_objective_vectorvaluedfunc_fixB_borehole, self).__init__()
...
class VV_CV_vectorvaluedfuncs_model_fixB_borehole(object):
